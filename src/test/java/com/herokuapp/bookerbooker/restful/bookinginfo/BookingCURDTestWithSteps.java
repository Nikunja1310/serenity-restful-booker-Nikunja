package com.herokuapp.bookerbooker.restful.bookinginfo;

import com.herokuapp.bookerbooker.restful.model.BookingPojo;
import com.herokuapp.bookerbooker.restful.testbase.TestBase;
import com.herokuapp.bookerbooker.restful.utils.TestUtils;
...
public class BookingCURDTestWithSteps extends TestBase {
    ...
    static String additionalneeds = "Brekky";
    static String token;
    static int id;
